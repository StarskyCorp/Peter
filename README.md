...
If you are using `AuthenticationApiFixture` inheriting from your own *fixture* that also use the method `ConfigureWebHost`, remember to call base method with `base.ConfigureWebHost(builder);`. 

In the [Api.Tests](tests/Api.Tests) project you can see how to use these classes in a real testing scenario.
